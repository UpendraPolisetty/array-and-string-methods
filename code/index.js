...
console.log(addTwo(22))
  ...
  */
     ...
     console.log( addTwoToArray(numArr));
  ...
  */
     ...
     console.log( addThreeToArray(numArr));
  ...
  */
     ...
     console.log( addFiveToArray(numArr));
  ...
  */
  ...
  console.log(changeArray(numArr,addTwo));
  console.log(changeArray(numArr,addThree));
  console.log(changeArray(numArr,addFive));
  ...
  */
     ...
     console.log( sendMessage( 'hello' , function (msg){ console.log(msg);}) )
     console.log( sendMessage( 'hello Alert' , function (msg){ alert(msg);}) )
     console.log( sendMessage( 'hello Prompt' , function (msg){ prompt(msg);}) )
  ...
  */
    ...
    console.log(callMe ( function (){ return 20 }))
  ...
  */
  ...
  function filterGradeA(objects){
    let final = [];
    for(let obj of objects){
      if(isGradeA(obj) == true) {
        final.push(obj)
      }
    }
    return final;
  ...
  */
  ...
  function filterGradeB(objects){
    let final = [];
    for(let obj of objects){
      if(isGradeB(obj) == true){
        final.push(obj)
      }
    }
    return final;
  ...
  */
  ...
  function filterGradeC(objects){
    let final = [];
    for(let obj of objects){
      if(isGradeC(obj)== true){
        final.push(obj)
      }
    }
    return final;
